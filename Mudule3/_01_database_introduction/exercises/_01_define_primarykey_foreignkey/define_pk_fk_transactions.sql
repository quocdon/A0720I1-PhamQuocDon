...
--
-- Host: localhost    Database: define_pk_fk
-- ------------------------------------------------------
...
CREATE TABLE `transactions` (
  ...
  UNIQUE KEY `tran_number` (`tran_number`),
  UNIQUE KEY `tran_number_2` (`tran_number`),
  KEY `account_number` (`account_number`),
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `accounts` (`account_number`),
  CONSTRAINT `transactions_chk_1` CHECK ((`tran_amount` > 0))
...
-- Dump completed on 2020-12-02 20:21:10
