        ...
        <div class="col-sm-10 d-flex justify-content-center">
            <form method="post" action="employee-edit" class="col-sm-6">
                ...
                <table class="table table-striped">
                    <tr class="form-group">
                        <td>Mã nhân viên:</td>
                        <td><input class="form-control" type="text" name="id" value="${employee.id}" required readonly></td>
                    </tr>
                    <tr class="form-group">
                        <td>Tên đăng nhập:</td>
                        <td><input class="form-control" type="text" name="username" value="${employee.username}" required readonly></td>
                    </tr>
                    <tr class="form-group">
                        <td>Họ tên:</td>
                    ...
                    <tr class="form-group">
                        <td>Ngày sinh:</td>
                        <td><input class="form-control" type="date" name="birthday" value="${employee.birthday}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Số CMND:</td>
                        <td><input class="form-control" type="text" name="idCard" value="${employee.idCard}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Lương:</td>
                        <td><input class="form-control" type="text" name="salary" value="${employee.salary}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Số điện thoại:</td>
                        <td><input class="form-control" type="text" name="phone" value="${employee.phone}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Email:</td>
                        <td><input class="form-control" type="email" name="email" value="${employee.email}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Địa chỉ:</td>
                        <td><input class="form-control" type="text" name="address" value="${employee.address}" required></td>
                    </tr>
                    <tr class="form-group">
                        <td>Vị trí:</td>
                        <td>
