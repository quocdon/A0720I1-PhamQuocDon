        ...
        <div class="col-sm-10 flex-column justify-content-center">
            <table class="table table-bordered col-sm-6" style="margin: auto">
                <tr>
                    ...
                    <td class="col-sm-4 text-center">${employee.id}</td>
                </tr>
                <tr>
                    <td>Họ tên:</td>
                ...
                <tr>
                    <td>Trình độ:</td>
                    <td class="text-center">${employee.educationDegreeName}</td>
                </tr>
                <tr>
                    <td>Vị trí:</td>
            ...
            <div class="col-sm-3" style="margin: auto;">
                <a class="btn btn-outline-primary btn-block text-center" href="employee-list">Quay lại</a>
            </div>
        </div>
    </div>
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/css/bootstrap-4.6.0/dist/css/bootstrap.css">
